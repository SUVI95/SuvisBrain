  ...
  try {
    ...
    const result = await query(
      ...
      SELECT
        ...
        l.mother_tongue,
        l.learning_goal,
        l.learner_goal_domain,
        l.teacher_focus_area,
        l.teacher_support_type,
        l.teacher_barrier,
        l.teacher_life_context,
        l.teacher_confidence_note,
        l.teacher_next_action,
        l.teacher_followup_flag,
        l.teacher_last_action_at,
