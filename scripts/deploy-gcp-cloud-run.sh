...
echo "  Widget JS:    $VOICE_URL/hsbridge-knuut.js"
echo "  Voice session: $SESSION_URL"
echo "  Health:       $VOICE_URL/health"
echo "  Smoke test:   $VOICE_URL/api/widget-smoke?deep=1"
echo ""
echo "Framer Site Settings → Custom Code → End of <body>:"
echo "  1. KEEP the KNUUT_INST script."
echo "  2. DELETE the old inline WebRTC script (the one with const SRV=... and RTCPeerConnection)."
echo "  3. PUT THIS IN ITS PLACE:"
echo ""
echo "  <script src=\"${VOICE_URL}/hsbridge-knuut.js\"></script>"
echo ""
echo "Then publish the Framer site. The existing KnuutButton still calls window.knuutStart()."
echo "=============================================="
